...
// Yoctopuce error codes, used by default as function return value
  ...
  public class YDevice
  {
    ...
    { 
     ...
     res = _yapiHTTPRequestSyncStart(ref iohdl , new StringBuilder(device) , new StringBuilder(request),ref preply,ref replysize,buffer);
     if(res<0) 
  ...
  public YRETCODE HTTPRequestAsync( string  request, ref string  errmsg)
    {
     ...
     res = _yapiHTTPRequestAsync(new StringBuilder(_rootdevice), new StringBuilder(fullrequest), default(IntPtr), default(IntPtr), buffer);
     errmsg = buffer.ToString();
     return  res;
  }


  public YRETCODE HTTPRequestPrepare(string request, ref string fullrequest , ref string errmsg)
    {
      ...
      p = request.IndexOf("/");
      fullrequest = request.Substring(0, p) + _subpath + request.Substring(p + 1, request.Length - p - 1);
  ...
  */
  ...
  private extern static int _yapiHTTPRequestSyncStart(ref YIOHDL iohdl, StringBuilder device, StringBuilder url, ref IntPtr reply,  ref int replysize,   StringBuilder errmsg);
  ...
  private extern static int _yapiHTTPRequestAsync( StringBuilder device, StringBuilder url,  IntPtr callback,IntPtr context, StringBuilder errmsg);
